...
echo 'lista-contato-api start begin'
...
echo 'load lista-contato-api config'
. ${COMPONENT_DIR}/bin/env.sh

echo "start lista-contato-api app on port ${MY_API_PORT}"
#start component
...
echo 'lista-contato-api start done'
